                ...
                <div className="grid grid-cols-2 gap-x-16 gap-y-20">
                  {stats.map((stat, index) => (
                    ...
                    >
                      ...
                      <div className="absolute left-0 -bottom-4 w-16 h-0.5 bg-green-500" />
          ...
          <div className="py-10">
            <div className="bg-gray-50 p-6">
              ...
              <div className="relative mb-6">
                <div className="absolute left-0 w-24 h-1 bg-green-500" />
                <div className="absolute left-0 w-12 h-1 bg-green-500/30 my-2" />
              </div>
